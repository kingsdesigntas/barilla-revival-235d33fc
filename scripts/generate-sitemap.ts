...
const entries: SitemapEntry[] = [
  ...
  { path: "/accommodation/booking-policy", changefreq: "yearly", priority: "0.4" },
  { path: "/cabin-accommodation-hobart", changefreq: "monthly", priority: "0.7" },
  { path: "/accommodation/caravan-parks-hobart", changefreq: "monthly", priority: "0.7" },
  { path: "/accommodation/family-friendly-holiday-park-accommodation-in-hobart", changefreq: "monthly", priority: "0.7" },
];
