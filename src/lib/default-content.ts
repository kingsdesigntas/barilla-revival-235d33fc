...
export const defaultAirportPage = {
  ...
  benefits: [
    ...
    { icon: "Bus", heading: "Close to Caravan Hire Drop-Off Locations", description: "Conveniently located near major caravan and motorhome hire depots for an easy start or finish to your trip." },
  ],
  locationInfo: {
