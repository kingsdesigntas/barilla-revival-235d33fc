  ...
  items: [
    {
      ...
      sleeps: "Sleeps 4-6 in a range of sleeping configurations",
      tagline: "Most popular",
      description: "Our most popular option, these Two Bedroom Cabins sleep up to six guests and offer practical, affordable accommodation with flexible bedding, a kitchen, and cosy living area. Perfect for families, workers, or small groups exploring Tasmania comfortably together.",
      features: [
...
export const defaultContactPage = {
  title: "Contact Barilla Holiday Park",
  ...
  contactHeading: "Contact Barilla Holiday Park",
  contactDescription: "Our friendly team is always here to help with local advice, travel tips and any questions you may have during your stay at Barilla Holiday Park.",
  phone: "1800 465 453",
  email: "stay@barilla.com.au",
